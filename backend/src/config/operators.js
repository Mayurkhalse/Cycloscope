/**
 * Cycloscope Meteorological & Oceanographic Workstation
 * Pre-configured Operator Profiles & Role-Based Access Control (RBAC) Definitions
 * 
 * Supports distinct operational roles:
 *  - Operational Meteorologist (RSMC New Delhi / IMD)
 *  - Cyclone Research Analyst (INCOIS Ocean Valley)
 *  - Disaster Response Coordinator (NDMA New Delhi)
 *  - Workstation Systems Administrator (National Data Center, Pune)
 */
...
const PRESET_OPERATORS = [
  {
    ...
    station: 'RSMC New Delhi HQ (Mausam Bhawan)',
...
module.exports = { PRESET_OPERATORS };
